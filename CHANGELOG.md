...
### Fixed
- the Wago link in the panel goes somewhere
...
### Added
- let ambassadors moderate the alliance channel
...
### Added
- choose per event whether the alliance sees it

### Fixed
- keep guild events private unless an officer shares them
...
### Added
- calendar — edit & delete events, descriptions, and categories
